...
const IconButton = React.forwardRef<HTMLButtonElement, PropsWithChildren<IconButtonProps>>(
  (props, ref: ForwardedRef<HTMLButtonElement>) => {
    const { children, primary, secondary, basic, error, raised, disabled, loading, ...rest } =
      props;
    ...
    function checkTypeVariation({ primary, secondary, basic, error }: IconButtonProps) {
    ...
    return (
      <button ref={ref} type="button" {...rest} className={classes} disabled={disabled}>
